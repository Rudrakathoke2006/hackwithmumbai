                  ...
                  <form onSubmit={handleSignIn} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between items-center px-1">
                        ...
                        <button
                          type="button"
                          className="text-[11px] font-bold text-neon-blue hover:text-neon-blue/80 transition-colors uppercase tracking-tight"
                        >
                          Forgot?
                        </button>
                      </div>
                    ...
                    <motion.button
                      ...
                      disabled={isLoading}
                      className={cn(
                        'w-full font-display font-bold py-4 rounded-2xl text-white',
